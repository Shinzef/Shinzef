        ...
        <div class="content-body">
            <div class="markdown-block">
                <div class="code-header">
                    <span class="file-type">Notes</span>
                    <div class="code-actions">
                        <button class="code-btn" title="Share">
                ...
                <div class="code-content">
                    <div class="notes-writing-area">
                        <textarea class="random-textarea" placeholder="Start writing your thoughts... ✨

What's on your mind today? You can write anything here - ideas, reflections, random thoughts, or just notes for later."></textarea>
                        ...
                        <div class="notes-footer">
                            ...
                            <div class="notes-actions">
                                <button class="action-btn save-local" data-tab-id="${tabId}" title="Save to browser">
                                    <i class='bx bx-save'></i>
                                    Save Local
                                </button>
                                <button class="action-btn send-to-sheets primary" data-tab-id="${tabId}" title="Send to Google Sheets">
...
function setupRandomContentHandlers(tabId) {
    ...
    const textarea = document.querySelector(`#${tabId}-content .random-textarea`);
    ...
    if (sendBtn && textarea) {
        sendBtn.addEventListener('click', async () => {
            ...
            try {
                const response = await sendToGoogleSheets(content);
                showSaveNotification('✨ Sent to Google Sheets!');
                
                // Optionally clear the textarea after successful send
                // textarea.value = '';
                ...
                showErrorNotification('Failed to send. Please try again.');
            } finally {
...
async function sendToGoogleSheets(user, message) {
    const payload = {
        secretKey: "EK8lYA5boKtzuiqD2e", // Your existing token as secret key
        user: user,
        message: message
    };
